...
--
-- Indexes for table `tbl_placeinfo`
--
ALTER TABLE `tbl_placeinfo`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tbl_hotel`
  MODIFY `h_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tbl_package_type`
  MODIFY `pt_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tbl_placeinfo`
--
ALTER TABLE `tbl_placeinfo`
