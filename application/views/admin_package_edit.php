...
<?php echo form_open_multipart('admin/updat_pack');?>
            ...
            <label>Package Title</label><br>
                  <?php echo form_input(array('name'=>'pName'),$data->Title);?><?php echo '<div class="error">'.form_error('pName').'</div>';?><br>
                 
          <label>Package Price</label><br>
              <?php echo form_input(array('name'=>'p_price'),$data->Package_price);?><?php echo '<div class="error">'.form_error('p_price').'</div>';?><br>
              
               <label>Package Type</label><br>
             <select name="d_type">
    
    <option value="none"><?php echo $data->Package_Type;?></option>
  <?php 
  ...
  ?>
        ...
        <br>
            ...
            <input type="date" name="ts" value="<?php echo $data->Start_Date;?>"><?php echo '<div class="error">'.form_error('ts').'</div>';?><br>    
             <label>Tour End Date</label><br>    
            <input type="date" name="te" value="<?php echo $data->End_Date;?>"><?php echo '<div class="error">'.form_error('te').'</div>';?><br>        
    ...
    <option value="none"><?php echo $data->Jour_start?></option>
  <?php 
  ...
  <select name="d_des">
      ...
      <option value="none" class="divider"><?php echo $data->Jour_Destination?></option>
  <?php 
 ...
 <select name="d_aco">
    ...
    <option value="none"><?php echo $data->Acommodation?></option>
  <?php 
...
<select name="country">
    ...
    <option value="none"><?php echo $data->Country?></option>
  <?php 
...
<textarea  name="longdes" id="mytextarea"><?php echo $data->plan?> </textarea><?php echo '<div class="error">'.form_error('longdes').'</div>';?>
<label>Image</label>
    <?php echo form_upload('pic').$data->Image?><?php echo '<div class="error">'.form_error('pic').'</div>';?><br><br>
    &nbsp;&nbsp;
    <label>Image2</label>
    <?php echo form_upload('pic1').$data->Image1;?><?php echo '<div class="error">'.form_error('pic1').'</div>';?><br>
         
 <?php echo form_submit(array('name'=>'submit'),'Update');?>
