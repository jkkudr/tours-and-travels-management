 ...
 <center>
     ...
     <form action="<?php echo base_url().'admin/update';?>" method="post">
       ...
       <?php foreach ($user as $row) { ?>
		...
		<table width="520">
                <tr>
                    <td><input type="text" name="user_id" value="<?php echo $row->uid;?>" size="50" hidden=""></td>
                
                </tr>
                <tr>
                <td><input type="text" name="fname" value="<?php echo $row->Firstname;?>" size="50" placeholder="First Name" ></td>
                <td><input type="text" name="lname" value="<?php echo $row->Lastname;?>" size="50" placeholder="Last Name" ></td>
                </tr>
                ...
                <input type="email" name="email_address" id="email_address" value="<?php echo $row->Email;?>" size="50" placeholder="Your e-mail">
                ...
                <input type="password" name="password" value="<?php echo $row->Password;?>" size="50" placeholder="Current Password"   >
                </td>
                </tr>
                ...
                <input type="text" name="phone" value="<?php echo $row->Phoneno;?>" size="50" placeholder="Phone NO" >
                </td>
                </tr>
                <tr>
                <td colspan="2">
                    
                    <input type="text" name="address" value="<?php echo $row->Address;?>" size="50" placeholder="Address" >
                </td>
                </tr>
  ...
  <!-- <tr>	
       <td><input type="radio" name="gender" id="radio1" class="radio" value="Male" <?php echo set_radio($row=='Male') ?>/> <label for="radio1">Male</label></td>	
       <td><input type="radio" name="gender" id="radio2" class="radio" value="Female" <?php echo set_radio($sex=='Female') ?>/> <label for="radio2">Female</label></td>		
  </tr>-->
                
  <tr>

  <td width="auto"><center><button type="submit" name="btn_signup" value="Submit">Profile Update</button></center> </td>
 </tr>
</table>
       <?php } ?>
