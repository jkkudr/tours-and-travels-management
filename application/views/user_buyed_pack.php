...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url().'user/view_pack';?>"><i class="fa fa-table fa-fw"></i> View Packages</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url().'user/aftr_buy_pak';?>"><i class="fa fa-edit fa-fw"></i> Forms</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
           ...
           <div class="panel panel-default">
               <div class="panel-heading">New Package Buy</div>
    ...
    <tr>
        ...
        <td ><a href="<?php echo base_url().'user/mypdf';?>" class="btn btn-primary btn-success active" role="button">Print</a></td>
    </tr>
    <?php }?>
</table>
