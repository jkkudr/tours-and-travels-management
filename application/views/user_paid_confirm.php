...
<form action="<?php echo base_url().'user/confirm_order';?>" method="post">
       ...
       <?php foreach ($pro as $row) { ?>
		...
		<table width="520">
                <tr>
                <label>Card No.</label>
                    <td><input type="text" name="user_id" value="<?php echo $row->id;?>" size="50" hidden="" >
                
                    <input type="text" name="cardno" value="" size="50" ></td>
                    <td>
                        
                        <input type="text" name="invoice" value="<?php echo 'Inv-'.rand()?>" hidden="">
                        
                    </td>
                </tr>
                <tr>
                    <td>
                        <label>CVV2 no.</label><br>
                        <input type="text" name="pin">
                    </td>
                </tr>
                <tr>
                    
                    <td><label>Enter Amount</label><br>
                        <input type="text" name="amunt" placeholder="Enter the payable amount">
                    </td>
                </tr>
                <tr>
                    <td>
                        <label>Choose Payment Option:</label><br>
            <input type="radio" name="pay" value="Mastercard">Mastercard
            <input type="radio" name="pay" value="Visa">Visa
                ...
                <tr>
                    <td><input type="text" name="fname" value="<?php echo $row->Title;?>" size="50" placeholder="First Name" hidden=""></td>
                    <td><input type="text" name="lname" value="<?php echo $row->Package_id;?>" size="50" placeholder="Last Name" hidden=""></td>
                </tr>
                ...
                <td colspan="2">
                    ...
                    <input type="text" name="p_price"  value="<?php echo $row->Package_price;?>" size="50" placeholder="Your e-mail" hidden="">
				
                </td>
                </tr>
                <tr>
                    <td><input type="text" name="name" value="<?php echo $this->session->userdata('Fistname');?>" hidden=""></td>
                    <td><input type="text" name="uid" value="<?php echo $this->session->userdata('usrid');?>" hidden=""></td>
                    <td><input type="text" name="umail" value="<?php echo $this->session->userdata('email');?>"hidden=""></td>
                </tr>
                
                
  <tr>

  <td width="auto"><center><button type="submit" name="btn_signup" value="Submit">Confirm</button></center> </td>
 </tr>
</table>
       <?php } ?>
