...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> View Packages</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"></div>
                                    <div><strong><?php echo "Today is ". date("l")."<br>".date("d F Y")?></strong></div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                    ...
                    <?php echo $this->session->userdata('usrid');?>
  ...
  <div class="panel-body">
    ...
    <a href="<?php echo base_url().'user/view_details/'.$row->id;?>"<h4 style="color:#069"><?php echo $row->Title; ?></h4></a>
       ...
       <a href="<?php echo base_url().'user/view_details/'.$row->id;?>" class="btn btn-primary btn-info active" role="button">View Details</a>
       <a href="<?php echo base_url().'user/buy/'.$row->id;?>" class="btn btn-primary btn-info active" role="button">Buy</a>
  ...
  <div class="panel-footer">Click Here for More packages</div>
   <!-- page links-->
</div>
