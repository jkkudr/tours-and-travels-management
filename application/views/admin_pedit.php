            ...
            <div class="container-fluid">
                ...
                <div class="panel-body">
                    ...
                    <?php foreach ($res as $row){?>
                        <?php echo form_open('admin/up_p');?>
                      <?php echo form_hidden('id',$row->id);?>
                    <input type="text" class="form-control" name="placename" placeholder="Place name" value="<?php echo $row->Place_Location?>">
                        &nbsp;&nbsp;
                        <label>Place info</label><br>
                        <textarea name="p_info" id="mytextarea">
                            <?php echo $row->Place_Description;?>
                        </textarea>
                          &nbsp;&nbsp;&nbsp;&nbsp;<br>
                          &nbsp;&nbsp;&nbsp;&nbsp;<br>
                          <input type="text" name="session" value="<?php echo $this->session->userdata('usrid');?>" hidden="">
                          &nbsp;&nbsp;&nbsp;&nbsp;<br>
