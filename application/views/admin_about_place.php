        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <label style="color: #0075b0">Place Name:</label>  <?php echo $row->Place_Location; ?><br>
                    <label style="color: #0075b0">Description:</label><?php echo $row->Place_Description; ?><br>
                   <label style="color: #0075b0">Last Update:</label><?php echo $row->Date?><br>
                 ...
                 <div class="panel-footer"><a href="<?php echo base_url().'admin/ad_pedit/'.$row->id;?>" class="btn btn-primary btn-success active" role="button">EDIT</a>&nbsp;||&nbsp;<a href="<?php echo base_url().''.$row->id;?>" onclick="return confirm('Are you sure to Delete this Package?')" class="btn btn-default btn-danger active" role="button">Delete</a>
                     &nbsp;|| &nbsp;<a href="<?php echo base_url().'admin/ad_read/'.$row->id;?>" class="btn btn-primary btn-info active" role="button">Read</a>        </div>
                           <?php }?>
                </div>
