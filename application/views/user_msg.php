...
<script>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Mail to ADMIN</h1>
                    
                    
                    <div class="pane panel-default">
                        <div class="panel-body">
                            <form method="post" action="<?php echo base_url().'user/mail_send'?>">
                                <table>
                                <tr>
                                    <td> <input type="text" name="sender" value="<?php echo $this->session->userdata('usrid')?>" hidden=""></td>
                                    
                                </tr>
                                <tr>
                                    <td><label>Subject:</label><br></td>
                                    <td><input type="text" name="sub" class="form-control" required="">&nbsp;&nbsp;</td>
                                </tr>
                               
                                 <tr>
                                     <td> <label for="comment">Body:</label><br></td>

                                   <td>   <textarea class="form-control" rows="5" id="mytextarea" name='body'></textarea>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                </tr>
                              <tr>
                                    
                                  <td colspan="2"><input type="submit" value="Send" name="s" class="btn btn-primary btn-block"></td>
                                </tr>
                            </table>
                                </form>
                        </div>
