...
<head>
  ...
  <!-- Bootstrap core CSS-->
  <link href="<?php echo base_url();?>asset2/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
...
<a class="navbar-brand" href="index.html">ADMIN::{title}</a>
...
<i class="fa fa-fw fa-sign-out"></i>Logout</a>
  ...
  {content}
    ...
    <script src="<?php echo base_url();?>asset2/js/sb-admin-datatables.min.js"></script>
